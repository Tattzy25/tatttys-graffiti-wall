...
export function SprayCan({ color, isSelected, onClick, label }: SprayCanProps) {
  return (
    ...
    >
      ...
      >
        {/* Nozzle/Cap */}
        <rect x="18" y="0" width="12" height="8" rx="2" fill="#2a2a2a" />
        <rect x="20" y="2" width="8" height="4" rx="1" fill="#1a1a1a" />
        <ellipse cx="24" cy="3" rx="2" ry="1" fill="#444" />
        ...
        {/* Highlight stripe */}
        <rect x="10" y="12" width="6" height="80" rx="1" fill="rgba(255,255,255,0.3)" />
        
        {/* Dark stripe for depth */}
        <rect x="36" y="12" width="3" height="80" fill="rgba(0,0,0,0.2)" />
        
        {/* Label band */}
        <rect x="8" y="35" width="32" height="30" fill="rgba(255,255,255,0.15)" />
        <rect x="8" y="35" width="32" height="2" fill="rgba(0,0,0,0.2)" />
        <rect x="8" y="63" width="32" height="2" fill="rgba(0,0,0,0.2)" />
        
        {/* Color indicator dot */}
        <circle cx="24" cy="50" r="8" fill={color} stroke="rgba(255,255,255,0.4)" strokeWidth="2" />
